...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class NamedServiceExtensions
    {
        ...
        public static IServiceCollection AddNamed(this IServiceCollection services, string name, Type implementationType, ServiceLifetime lifetime)
        {
            return lifetime switch
            {
                ServiceLifetime.Singleton => services.AddNamedSingleton(name, implementationType),
                ServiceLifetime.Transient => services.AddNamedTransient(name, implementationType),
                _ => services.AddNamedScoped(name, implementationType)
            };
        }
        ...
        public static IServiceCollection AddNamedScoped<TService>(this IServiceCollection services, string name) where TService : class 
        ...
        /// </summary>
        /// <param name="name">服务名称</param>
        public static IServiceCollection AddNamedSingleton<TService>(this IServiceCollection services, string name) where TService : class 
